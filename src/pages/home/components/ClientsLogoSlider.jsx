...
const ClientsLogoSlider = () => {
  ...
  const clients = [
    { id: 1, image: "/standard.PNG", industry: "Technology" },
    { id: 2, image: "/oldmutual.PNG", industry: "Real Estate" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">
            Our Valued <span className="bg-gradient-to-r from-amber-500 to-amber-700 bg-clip-text text-transparent">Partners</span>
          </h2>
          ...
          <div className="overflow-hidden">
            <div className="flex animate-scroll hover:pause-animation">
              ...
              {duplicatedClients.map((client, index) => (
                <div key={`${client.id}-${index}`} className="flex-shrink-0 mx-3 w-56">
                  <div className="group bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-amber-400 h-28 flex items-center justify-center">
